...
char *error_122(char **args);
char *error_123(char **args);

/**
 * error_122 - Creates an error message for permission denied failures.
...
/**
 * error_123 - Outputs an error message for command not found failures.
 * @args: An array of arguments passed to the command.
 * Return: The error string.
 */
char *error_123(char **args)
